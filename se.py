...
def scrape_and_display_images(url):
...
# Example usage
url_to_scrape = "https://en.wikipedia.org/wiki/Subhas_Chandra_Bose"
scrape_and_display_images(url_to_scrape)